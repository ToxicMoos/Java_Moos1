package homeWork23.sentenceTest;
...
public class Sentence {
    ...
    public int wordsNiSentence(String sentence){
    ...
    public int lettersInSentence(String sentence) {
        String[] symbols = sentence.replaceAll("[^а-яА-Я]","").split("");
        System.out.println("There are " + symbols.length + "  letters in the sentence.");
