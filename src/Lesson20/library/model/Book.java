package Lesson20.library.model;
...
public class Book {
    ...
    public static final int ISBN_LENGTH =13;//Константа, никто не может поменять это значение
...
//конструктор без автора? на случай если нет автора
    ...
    private int countDigits(long isbn){
        int count = 0;
        do {
            count++;      //счетчик количества чисел
    ...
    public boolean equals(Object o) {
        ...
        Book book = (Book) o;
        return   isbn == book.isbn  ;// это позволяет искать быстро книгу по isbn
    }
