package Lesson37.employee_company.model;
...
public abstract class Employee implements Comparable<Employee>{
        ...
        public boolean equals(Object o) {
            ...
            Employee employee = (Employee) o;// Приведение объекта к типу Employee

            return id == employee.id; // находим сотрудника по табельному номеру
//            return id == employee.id && name.equals(employee.name);                       // Пример сравнения по полям ID и имени
        }
